...
const Sidebar = () => {
  ...
  const activeLink =
    `flex items-center gap-5 ${open ? "pl-4" : "pl-0"} pt-3 pb-2.5 rounded-lg text-white text-md m-2 `;
    const normalLink =
    `flex items-center gap-5pl-${open ? "pl-4" : "pl-0"} pt-3 pb-2.5 rounded-lg text-md text-gray-700 dark:text-gray-200 m-2`;
